...
export interface StudentDetailItem {
  ...
  Feealreadyreleased:number;
  AmountReleaseonFulltimecourses:number;
  AmountReleaseonParttimecourses:number;
...
const EXAMPLE_DATA: StudentDetailItem[] = [
  {PEI:"1000",NumberofStudents:1000,Feealreadyreleased:10000,AmountReleaseonFulltimecourses:100000,AmountReleaseonParttimecourses:50000},
  ...
  private getSortedData(data: StudentDetailItem[]): StudentDetailItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'Feealreadyreleased': return compare(a.Feealreadyreleased, b.Feealreadyreleased, isAsc);
        case 'AmountReleaseonFulltimecourses': return compare(a.AmountReleaseonFulltimecourses, b.AmountReleaseonFulltimecourses, isAsc);
        case 'AmountReleaseonParttimecourses': return compare(a.AmountReleaseonParttimecourses, b.AmountReleaseonParttimecourses, isAsc);
