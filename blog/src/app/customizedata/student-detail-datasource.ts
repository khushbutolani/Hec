...
export interface StudentDetailItem {
  ...
  AmountofFundReleased:number;
  DateFundreleasedtoPEIs:string;
...
const EXAMPLE_DATA: StudentDetailItem[] = [
  {PEI:"1000",ProgrammeCodeandName:"ab11",ModuleCodeandName:"12ab",ProgrammeLevel:"2",ModeOfStudy:"online",NumberofStudents:1000,AmountofFundReleased:10000,DateFundreleasedtoPEIs:"12/4/21"},
  ...
  private getSortedData(data: StudentDetailItem[]): StudentDetailItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'ModuleCodeandName': return compare(a.ModuleCodeandName, b.ModuleCodeandName, isAsc);
        case 'ProgrammeLevel': return compare(a.ProgrammeLevel, b.ProgrammeLevel, isAsc);
        case 'ModeOfStudy': return compare(a.ModeOfStudy, b.ModeOfStudy, isAsc);
        case 'NumberofStudents': return compare(a.NumberofStudents, b.NumberofStudents, isAsc);
        case 'AmountofFundReleased': return compare(a.AmountofFundReleased, b.AmountofFundReleased, isAsc);
        case 'DateFundreleasedtoPEIs': return compare(a.DateFundreleasedtoPEIs, b.DateFundreleasedtoPEIs, isAsc);
