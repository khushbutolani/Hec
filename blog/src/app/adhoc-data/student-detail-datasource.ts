...
export interface StudentDetailItem {
  PEI : string;
  FacultyClusterId:number;
  ProgrammeCode: string;
  ClaimFileNo:number;
  AmountPaidtoPEI:number;

}

// TODO: replace this with real data from your application
const EXAMPLE_DATA: StudentDetailItem[] = [
  {PEI: "1000",FacultyClusterId:1,ProgrammeCode:"1111",ClaimFileNo:121,AmountPaidtoPEI:10000},
  ...
  private getSortedData(data: StudentDetailItem[]): StudentDetailItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'FacultyClusterId': return compare(a.FacultyClusterId, b.FacultyClusterId, isAsc);
        case 'ProgrammeCode': return compare(a.ProgrammeCode, b.ProgrammeCode, isAsc);
        case 'ClaimFileNo': return compare(a.ClaimFileNo, b.ClaimFileNo, isAsc);
        case 'AmountPaidtoPEI': return compare(a.AmountPaidtoPEI, b.AmountPaidtoPEI, isAsc);
