...
const EXAMPLE_DATA: StudentDetailItem[] = [
  {PEI: "2000",ProgrammeCode:"222",ProgrammeName:"xyz",NoofStudents:50,TutionFees:200000,GeneralFees:20000,ModeofStudy:"online"},
  ...
  private getSortedData(data: StudentDetailItem[]): StudentDetailItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'ProgrammeName': return compare(a.ProgrammeName, b.ProgrammeName, isAsc);
        case 'NoofStudents': return compare(a.NoofStudents, b.NoofStudents, isAsc);
        case 'TutionFees': return compare(a.TutionFees, b.TutionFees, isAsc);
        case 'GeneralFees': return compare(a.GeneralFees, b.GeneralFees, isAsc);
